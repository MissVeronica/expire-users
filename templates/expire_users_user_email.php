 ...
 * When UM Settings -> Emails is entered the email template is copied to your child theme folder {your-theme}/ultimate-member/email/expire_users_user_email.php
 * Version 1.0.0
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin:40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666;">
	...
	<div style="padding: 0 30px 30px 30px;border-bottom: 3px solid #eeeeee;">
		<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px;">
			...
			Your Account {username} User Role {expiration-role} has expired today.
			You can renew your free User Role at your Account page and accept the renewal with the {expiration-link} button.</span>
		</div>
