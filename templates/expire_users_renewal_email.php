 ...
 * Event: User Role Renewal
 * Destination: Admin
 * This template source is located in the plugin's templates folder. 
 * When UM Settings -> Emails is entered the email template is copied to your child theme folder {your-theme}/ultimate-member/email/expire_users_renewal_email.php
 * Version 1.0.0
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
...
<div style="max-width: 560px;padding: 20px;background: #ffffff;border-radius: 5px;margin:40px auto;font-family: Open Sans,Helvetica,Arial;font-size: 15px;color: #666;">
	...
	<div style="padding: 0 30px 30px 30px;border-bottom: 3px solid #eeeeee;">
		<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px;">
			User Role Renewal<span style="display: block;">
			This Account {username} User Role has been renewed to the {expiration-role} Role today. 
